...
class BERN2():
    ...
    async def _ner_wrap(self, ner_type, pubtator_file, output_mtner, base_name, loop):
        if ner_type == 'gnormplus':
            ...
            print("mtner async called now looking for output in the file")
